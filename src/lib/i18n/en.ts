...
export const en: Dictionary = {
  ...
  editor: {
    ...
    splitResize: "Drag to set how wide each panel is",
    splitBoth: "Show the form and the page",
    splitFormOnly: "Form only",
    splitPaperOnly: "Page only",
    matchJobHint:
  ...
  preview: {
    ...
    zoomExact: "Type the zoom level yourself, as a percentage",
    zoomStep: "How much one press adds or removes",
    pageLabel: "Page",
    paperSize: "Paper size",
