...
export const id = {
  ...
  editor: {
    ...
    splitResize: "Tarik untuk mengatur lebar kedua panel",
    splitBoth: "Tampilkan formulir dan kertas",
    splitFormOnly: "Formulir saja",
    splitPaperOnly: "Kertas saja",
    matchJobHint:
  ...
  preview: {
    ...
    zoomExact: "Ketik perbesarannya sendiri, dalam persen",
    zoomStep: "Sekali tekan menambah atau mengurangi sekian persen",
    pageLabel: "Halaman",
    paperSize: "Ukuran kertas",
